package com.nubian.ai.runtime.model;
...
public class ProcessorConfig {
    ...
    /**
     * Optional run/thread scope used to resolve run-bound tool instances.
     */
    private String toolScopeId;
    ...
    public String getToolScopeId() {
        return toolScopeId;
    }

    public ProcessorConfig setToolScopeId(String toolScopeId) {
        this.toolScopeId = toolScopeId;
        return this;
    }
}
